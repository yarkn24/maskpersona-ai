...
persona-forge produces an **unendorsed persona interpretation** of a public figure, built from their
**public content**. Please read before using.

## What a persona-forge bot is and is not
...
figure's voice and isolate their turns in panels. **persona-forge does not synthesize, clone, or
