...
> **IMPORTANT: persona-forge does NOT synthesize, clone, or generate audio.** The voice fingerprint is a
...
public release; it runs on CPU via ONNX Runtime with no PyTorch. `pip install "persona-forge[voice]"`
