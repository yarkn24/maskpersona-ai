...
try:
    ...
    sys.exit("This demo needs 'rich'. Install demo extras: pip install \"persona-forge[demo]\"  (or: pip install rich)")
...
def _make_log(name: str) -> list[str]:
    ...
    return [
        f"[bold cyan]>[/] persona-forge ingest --persona {name}",
